...
{
    uint8 staticBits = (Vin_1_DR & (uint8)(~Vin_1_MASK));
    Vin_1_DR = staticBits | ((uint8)(value << Vin_1_SHIFT) & Vin_1_MASK);
}
...
{
	CyPins_SetPinDriveMode(Vin_1_0, mode);
}
...
{
    return (Vin_1_PS & Vin_1_MASK) >> Vin_1_SHIFT;
}
...
{
    return (Vin_1_DR & Vin_1_MASK) >> Vin_1_SHIFT;
}
...
/* If Interrupts Are Enabled for this Pins component */ 
    ...
    *******************************************************************************/
    ...
    {
        return (Vin_1_INTSTAT & Vin_1_MASK) >> Vin_1_SHIFT;
    }

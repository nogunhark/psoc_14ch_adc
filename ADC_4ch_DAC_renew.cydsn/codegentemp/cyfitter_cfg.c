...
#define BS_IOPINS0_0_VAL ((const uint8 CYFAR *)0x00080630u)

/* IOPINS0_1 Address: CYREG_PRT1_DM0 Size (bytes): 8 */
#define BS_IOPINS0_1_VAL ((const uint8 CYFAR *)0x00080638u)

/* IOPINS0_2 Address: CYREG_PRT2_DR Size (bytes): 10 */
#define BS_IOPINS0_2_VAL ((const uint8 CYFAR *)0x00080640u)

/* IOPINS0_4 Address: CYREG_PRT4_DM0 Size (bytes): 8 */
#define BS_IOPINS0_4_VAL ((const uint8 CYFAR *)0x0008064Cu)

/* CYDEV_CLKDIST_ACFG0_CFG0 Address: CYREG_CLKDIST_ACFG0_CFG0 Size (bytes): 4 */
#define BS_CYDEV_CLKDIST_ACFG0_CFG0_VAL ((const uint8 CYFAR *)0x00080654u)
...
static void AnalogSetDefault(void)
{
	...
	CY_SET_REG8((void CYXDATA *)CYREG_PRT0_AG, 0x0Fu);
	CY_SET_REG8((void CYXDATA *)CYREG_PRT1_AG, 0x30u);
	CY_SET_REG8((void CYXDATA *)CYREG_PRT2_AG, 0x3Fu);
	CY_SET_REG8((void CYXDATA *)CYREG_PRT4_AG, 0x03u);
	CY_SET_REG8((void CYXDATA *)CYREG_DSM0_SW0, 0xFFu);
	CY_SET_REG8((void CYXDATA *)CYREG_BUS_SW0, 0x03u);

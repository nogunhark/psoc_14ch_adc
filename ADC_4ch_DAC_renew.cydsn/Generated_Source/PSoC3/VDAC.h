...
*              Registers        
***************************************/
#define VDAC_CR0_REG            (* (reg8 *) VDAC_viDAC8__CR0 )
#define VDAC_CR0_PTR            (  (reg8 *) VDAC_viDAC8__CR0 )
#define VDAC_CR1_REG            (* (reg8 *) VDAC_viDAC8__CR1 )
#define VDAC_CR1_PTR            (  (reg8 *) VDAC_viDAC8__CR1 )
#define VDAC_Data_REG           (* (reg8 *) VDAC_viDAC8__D )
#define VDAC_Data_PTR           (  (reg8 *) VDAC_viDAC8__D )
#define VDAC_Strobe_REG         (* (reg8 *) VDAC_viDAC8__STROBE )
#define VDAC_Strobe_PTR         (  (reg8 *) VDAC_viDAC8__STROBE )
#define VDAC_SW0_REG            (* (reg8 *) VDAC_viDAC8__SW0 )
#define VDAC_SW0_PTR            (  (reg8 *) VDAC_viDAC8__SW0 )
#define VDAC_SW2_REG            (* (reg8 *) VDAC_viDAC8__SW2 )
#define VDAC_SW2_PTR            (  (reg8 *) VDAC_viDAC8__SW2 )
#define VDAC_SW3_REG            (* (reg8 *) VDAC_viDAC8__SW3 )
#define VDAC_SW3_PTR            (  (reg8 *) VDAC_viDAC8__SW3 )
#define VDAC_SW4_REG            (* (reg8 *) VDAC_viDAC8__SW4 )
#define VDAC_SW4_PTR            (  (reg8 *) VDAC_viDAC8__SW4 )
#define VDAC_TR_REG             (* (reg8 *) VDAC_viDAC8__TR )
#define VDAC_TR_PTR             (  (reg8 *) VDAC_viDAC8__TR )
/* Power manager */
#define VDAC_PWRMGR_REG         (* (reg8 *) VDAC_viDAC8__PM_ACT_CFG )
#define VDAC_PWRMGR_PTR         (  (reg8 *) VDAC_viDAC8__PM_ACT_CFG )
  /* Standby Power manager */
#define VDAC_STBY_PWRMGR_REG    (* (reg8 *) VDAC_viDAC8__PM_STBY_CFG )
#define VDAC_STBY_PWRMGR_PTR    (  (reg8 *) VDAC_viDAC8__PM_STBY_CFG )
...
/* Power manager */
#define VDAC_PWRMGR      (* (reg8 *) VDAC_viDAC8__PM_ACT_CFG )
  /* Standby Power manager */
#define VDAC_STBY_PWRMGR (* (reg8 *) VDAC_viDAC8__PM_STBY_CFG )
...
#define VDAC_ACT_PWR_EN   VDAC_viDAC8__PM_ACT_MSK
  /* Standby Power enable mask */
#define VDAC_STBY_PWR_EN  VDAC_viDAC8__PM_STBY_MSK
...
#define VDAC_CUR_MODE_OUT_OFF       0x1Eu 
